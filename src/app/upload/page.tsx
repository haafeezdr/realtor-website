...
const BUCKET_ID = "YOUR_BUCKET_ID"; // Replace with actual Appwrite Bucket ID
...
export default function ManagePropertiesPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-6 shadow-md rounded-lg mt-20">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <input type="number" name="price" placeholder="Price" value={propertyData.price} onChange={handleChange} className="w-full p-2 border rounded" required />
